...
agromoBaseUI <- function(id){
   ...
   tagList(shiny::tags$div(id = "base", shiny::tags$div(id="components","COMPONENTS"),
                 ...
                 class= "mainSideBar",
                        ...
                        shiny::tags$img(id = ns("huFlag"),src="www/img/HUflag_s.png"),
                        shiny::tags$img(id = ns("ukFlag"),src="www/img/UKflag_s.png"),
                        shiny::tags$img(id = ns("gerFlag"),src="www/img/GERflag_s.png"),
