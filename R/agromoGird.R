  agroMoGridUI <- function(id){
    ...
    shinyWidgets::switchInput(ns("ensclim"), label = NULL, onLabel="ensemble", offLabel="selected", value = TRUE)
    ),
    tags$div(
    id =paste0(ns("ensalg"),"_container"),
    shinyWidgets::switchInput(ns("ensalg"), label = NULL, onLabel="ensemble", offLabel="selected", value = TRUE)
    ),         
    tags$div(
      id =paste0(ns("enssoil"),"_container"),
      shinyWidgets::switchInput(ns("enssoil"), label = NULL, onLabel="ensemble", offLabel="selected", value = TRUE)
    ),
    tags$div(
    ...
    tags$div(
      ...
      shinyWidgets::switchInput(ns("annual"), label = NULL, onLabel="daily outputs", offLabel="annual outputs", value = TRUE)
    ),
    tags$div(
