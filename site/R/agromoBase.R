   ...
   tagList(tags$div(id = "base", tags$div(id="components","COMPONENTS"),
               tags$div(actionButton("site","", class = "mainMenu", style = ("background: url('img/site.svg')")),
                 ...
                 class= "mainSideBar",
                        ...
                        tags$div(id="mainSideBarLang", "LANGUAGES"),
                        tags$img(id = ns("huFlag"),src="img/HUflag_s.png"),
                        tags$img(id = ns("ukFlag"),src="img/UKflag_s.png"),
                        tags$img(id = ns("gerFlag"),src="img/GERflag_s.png"),
