...
Az integrált modellezési keretrendszer egy grafikus felhasználói felülettel (GUI) rendelkezik, amely könnyű és felhasználóbarát elérést bizosít az AgroMo rendszer funkcióihoz.
